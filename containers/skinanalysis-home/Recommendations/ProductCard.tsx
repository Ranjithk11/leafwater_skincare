...
import { Card, Box, Grid, Typography, Button, Chip, styled } from "@mui/material";
...
const StyledProductCard = styled(Card, {
  shouldForwardProp: (prop) => shouldForwardProp<{enabledMask?:boolean,minWidth?:number}>(["enabledMask","minWidth"],prop),
})<{ enabledMask?: boolean,minWidth?:number }>(({ theme, enabledMask,minWidth }) => ({
  height: "100%",
  ...(minWidth && {
   minWidth:minWidth,
   height: "auto",
